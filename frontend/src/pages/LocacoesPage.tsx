...
export default function LocacoesPage() {
  ...
  useEffect(() => {
    ...
    const seguro = seguros.find(s => s.id === Number(form.seguroId));
    const valorDiariaSeguro = seguro?.valorDiaria ?? 0;
    setPreview((veiculo.categoria.valorDiaria + valorDiariaSeguro) * dias);
  }, [form.veiculoId, form.seguroId, form.dataInicio, form.dataFimPrevista, veiculos, seguros]);
    ...
    <div className="page">
      ...
      <div className="card">
        ...
        <form className="grid-form" onSubmit={handleSubmit}>
          ...
          <input type="date" min={form.dataInicio || undefined} value={form.dataFimPrevista} onChange={e => setForm({ ...form, dataFimPrevista: e.target.value })} required />
